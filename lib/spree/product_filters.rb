module Spree
  ...
  module ProductFilters
    ...
    def ProductFilters.price_filter
      ...
      conds = [ [ I18n.t(:under_price, :price => format_price(30000))   , v[:price].lteq(30000)],
                [ "#{format_price(30000)} - #{format_price(50000)}"        , v[:price].in(30000..50000)],
                [ "#{format_price(50000)} - #{format_price(200000)}"        , v[:price].in(50000..200000)],
                [ I18n.t(:or_over_price, :price => format_price(200000)) , v[:price].gteq(200000)]]
