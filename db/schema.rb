...
ActiveRecord::Schema.define(:version => 20130304102015) do
  ...
  create_table "spree_orders", :force => true do |t|
    ...
    t.string   "state"
    t.decimal  "adjustment_total",                   :precision => 12, :scale => 2, :default => 0.0, :null => false
    t.integer  "user_id"
    t.datetime "created_at",                                                                         :null => false
    t.datetime "updated_at",                                                                         :null => false
    ...
    t.decimal  "payment_total",                      :precision => 12, :scale => 2, :default => 0.0
  ...
  create_table "spree_user_view_orders", :force => true do |t|
    t.integer  "user_id"
    t.integer  "order_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
